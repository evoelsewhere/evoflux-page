...
The production installers are hosted as public GitHub Release assets in `morphai-lab/evoflux-page` because their files exceed the GitHub Pages repository size limit. The website download cards point to the verified `v0.0.4` release.
