...
export const metadata: Metadata = {
  ...
  description: "EvoFlux is a local-first AI workspace for Cowork, agentic coding, WebBridge browser automation, and governed AI Innovation Modernization.",
  ...
  openGraph: {
    ...
    title: "EvoFlux — Cowork, Agentic Coding & AI Innovation Modernization",
    description: "One local-first AI workspace for Cowork, agentic coding, browser automation, and governed AI Innovation Modernization.",
    images: [{ url: "/og.png", width: 1200, height: 630, alt: "EvoFlux open cowork AI workspace" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "EvoFlux — Cowork, Agentic Coding & AI Innovation Modernization",
    description: "Local-first Cowork, agentic coding, browser automation, and AI Innovation Modernization.",
    images: ["/og.png"],
  },
};
  ...
  "@graph": [
    {
      ...
      url: SITE_URL,
      name: "EvoFlux",
      alternateName: ["EvoFlux Cowork", "EvoFlux Agentic Coding", "EvoFlux AIM"],
      description: "Local-first AI workspace for Cowork, agentic coding, browser automation, and AI Innovation Modernization.",
      inLanguage: ["en", "ja"],
    },
    {
      ...
      featureList: ["AI Cowork", "Agentic Coding", "WebBridge browser automation", "Layered sandbox", "AI Innovation Modernization"],
